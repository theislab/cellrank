...
CellRank is composed of :mod:`cellrank.tl.kernels `and :class:`cellrank.tl.estimators`. Kernels compute transition
matrices on the basis of directed data, given by i.e. RNA velocity [Bergen20]_ [Manno18]_ while estimators perform
inference given the kernel.
