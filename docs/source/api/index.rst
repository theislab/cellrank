...
- :doc:`Kernels <kernels>` compute cell-cell transition matrices using various input data modalities, including RNA velocity,
any pseudotime, a developmental potential, experimental time points, and more.
...
- In addition, there are :doc:`models <models>` for gene trend fitting, :doc:`plotting functions <plotting>` for
visualization, and :doc:`datasets <datasets>` that help you getting started with CellRank.
